...
// 获取草稿箱列表
export const getDraftArticles = (account) => {
  return requests({
    method: 'GET',
    url:`articles/listArticles?account=${account}&status=draft`
  })
}

// 获取垃圾箱列表
export const getDustbinArticles = (account) => {
  return requests({
    method: 'GET',
    url:`articles/listArticles?account=${account}&status=deleted`
  })
}
