<template>
  ...
  <div class="container">
    ...
    <div class="aside">
      ...
      <span  class="arr_left iconfont icon-zuojiantou" data-method="plus"></span>
      <div class="title">{{ theme }}</div>
      <span class="arr_right iconfont icon-youjiantou" data-method="reduce"></span>
      </span>
...
const changeTheme = (e)=>{
  ...
  if(e.target.dataset.method == 'plus'){
    ...
    state.preview_themeIndex = state.preview_themeIndex == 5? 0:state.preview_themeIndex

    state.preview_themeIndex++
  }else if(e.target.dataset.method == 'reduce'){
    state.preview_themeIndex --
    state.preview_themeIndex = state.preview_themeIndex == -1? 5:state.preview_themeIndex
  }
}
