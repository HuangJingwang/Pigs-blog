<template>
  ...
  <div class="container">
    ...
    <div class="aside">
      <button class="theme basic-box" @click="test">
      <button class="arr_left iconfont icon-zuojiantou"></button>
      <div class="title">{{ theme }}</div>
      <span class="arr_right iconfont icon-youjiantou" ></span>
      </button>
...
font-size: 50px;
color: rgb(38, 218, 218);
}
.aside .theme .iconfont:click{
  color: brown;
}
.aside .catalog {
  width: 100%;
