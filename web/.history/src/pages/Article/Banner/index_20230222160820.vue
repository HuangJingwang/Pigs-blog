  ...
  <div class="cover" :style="{backgroundImage:`url(${articleData.img_url})`}">
    <div class="articleInfo">
      ...
      <div class="breads">
        ...
        <span :style="{backgroundColor:'red',height:'50px',lineHeight:'50px',fontSize:'24px'}">\</span>
        <div class="date">
        ...
        <span>\</span>
        <div class="category"><span class="iconfont icon-shijian1"></span>
        <span> 文章分类: {{ articleData.group_id }}</span>
        </div>
      </div>
      <div class="view"></div>
    </div>
...
.breads .author,.breads .date .breads .category{
    display: flex;
    align-items: center;
}
</style>
