...
async function delete_pictures(pictures_url) {
  ...
  // 遍历图片路径 过滤未使用图片
  let  deletePicturesUrl = pictures_url.filter((url) => {
    return articleText.value.indexOf(url) == -1
  })
  console.log(deletePicturesUrl)
  console.log(pictures_url)
  ...
  // 删除图片
  let picturesData = {
    pictures_url: deletePicturesUrl,
  }
...
async function saveDraft() {
  ...
  data.article_picture_url = pictures_url
  console.log(data)
