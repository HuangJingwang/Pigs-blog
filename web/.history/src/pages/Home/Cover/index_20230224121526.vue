...
<div>
  <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shape-rendering="auto">
    ...
    <g class="parallax">
      <use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(3, 91, 120, 0.1)" />
      <use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(3, 91, 120, 0.3)" />
      <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(3, 91, 120, 0.5)" />
      <use xlink:href="#gentle-wave" x="48" y="7" fill="rgba(3, 91, 120, 0.8)"  />
    </g>
  </svg>
</div>
<!--Waves end-->
