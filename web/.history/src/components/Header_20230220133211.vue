<template>
 ...
 <el-dropdown>
  <div class="avatar" :style="{backgroundImage:'url(http://moon.starrysummer.com/cad31bce881d464e8a9964c97456b09e.jpg)'}"></div>
  <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item divide>退出登录</el-dropdown-item>
        </el-dropdown-menu>
      </template>
 </el-dropdown>
      </div>
...
.header .pig-left, .header .pig-right{
    width: 450px;
}
...
.pig-right .home,.pig-right .write,.pig-right .categories,.pig-right .archives,.pig-right .about,.pig-right .user{
  padding-top: 3px;
  border-radius: 5px;
  position: relative;
  overflow: hidden;
