<template>
  ...
  >
    ...
    <!-- 头部导航 -->
    <div class="header">
    <div class="btn_published">已发表</div>
...
/* 导航按钮 */
.btn_published,.btn_draft,.btn_dustbin{
  position: relative;
  width: 80px;
  font-size: 16px;
  height: 30px;
...
.btn_published::after,.btn_draft::after,.btn_dustbin::after{
  content: '';
  position: absolute;
  bottom: 0;
  left: 0;
  ...
  transition: all .2s;}
  .btn_published:hover::after,.btn_draft:hover:after,.btn_dustbin:hover:after{
width: 100%;
}
