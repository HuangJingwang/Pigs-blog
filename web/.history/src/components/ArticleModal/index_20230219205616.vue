<template>
  ...
  >
    ...
    <hr class="line" />
    <Published v-show="btn_active == 'published' ? true : false" :publishedList="publishedList" />
    <Draft v-show="btn_active == 'draft' ? true : false" :draftList="draftList" />
    <Dustbin v-show="btn_active == 'dustbin' ? true : false" :dustbinList="dustbinList" />
    <template #footer>
