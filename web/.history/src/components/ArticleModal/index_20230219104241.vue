<template>
  ...
  >
    ...
    <!-- 头部导航 -->
    <div class="header">
      <div :class="['btn_published',{active:btn_active=='published'?true:false}]">已发表</div>
      <div :class="['btn_draft',{active:btn_active=='draft'?true:false}]">草稿箱</div>
      <div :class="['btn_dustbin',{active:btn_active=='draft'?true:false}]">垃圾箱</div>
    </div>
    <hr class="line">
    <Published v-show="btn_active == 'published'?" />
    <Draft />
    <Dustbin />
    <template #footer>
